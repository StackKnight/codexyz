#!/usr/bin/env python3
"""Stage and optionally package the codexyz npm module."""
...
CODEX_NPM_NAME = "codexyz"
CODEX_PACKAGE_COMPONENT = "codex-package"

# `npm_name` is the local optional-dependency alias consumed by `bin/codexyz.js`.
# The underlying package published to npm is always `codexyz`.
CODEX_PLATFORM_PACKAGES: dict[str, dict[str, str]] = {
    "codex-linux-x64": {
        "npm_name": "codexyz-linux-x64",
        "npm_tag": "linux-x64",
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Build or stage the Codexyz CLI npm package.")
    parser.add_argument(
        "--package",
        ...
        if release_version:
            ...
            if package == "codex":
                print(
                    ...
                    "Verify the CLI:\n"
                    f"    node {staging_dir_str}/bin/codexyz.js --version\n"
                    f"    node {staging_dir_str}/bin/codexyz.js --help\n\n"
                )
...
def stage_sources(staging_dir: Path, version: str, package: str) -> None:
    ...
    if package == "codex":
        ...
        shutil.copy2(CODEX_CLI_ROOT / "bin" / "codexyz.js", bin_dir / "codexyz.js")
    ...
    if package == "codex":
        package_json["files"] = ["bin/codexyz.js"]
