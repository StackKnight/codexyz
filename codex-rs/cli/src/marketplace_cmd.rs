...
#[derive(Debug, Parser)]
#[command(bin_name = "codexyz plugin marketplace")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexyz plugin marketplace add",
    after_help = "Examples:\n  codexyz plugin marketplace add ./path/to/marketplace\n  codexyz plugin marketplace add owner/repo --ref main\n  codexyz plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "codexyz plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexyz plugin marketplace upgrade",
    after_help = "Examples:\n  codexyz plugin marketplace upgrade\n  codexyz plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexyz plugin marketplace remove",
    after_help = "Example:\n  codexyz plugin marketplace remove debug"
)]
