...
const GITHUB_LATEST_RELEASE_URL: &str =
    "https://api.github.com/repos/StackKnight/codexyz/releases/latest";
const HOMEBREW_CASK_API_URL: &str = "https://formulae.brew.sh/api/cask/codexyz.json";
...
fn update_action_label(context: &InstallContext) -> &'static str {
    match &context.method {
        InstallMethod::Npm => "npm install -g codexyz",
        InstallMethod::Bun => "bun install -g codexyz",
        InstallMethod::Brew => "brew upgrade --cask codexyz",
