...
#[derive(Debug, Parser)]
#[command(bin_name = "codexyz plugin")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexyz plugin add",
    after_help = "Examples:\n  codexyz plugin add sample@debug\n  codexyz plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexyz plugin list",
    after_help = "Examples:\n  codexyz plugin list\n  codexyz plugin list --marketplace debug\n  codexyz plugin list --json\n  codexyz plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "codexyz plugin remove",
    after_help = "Examples:\n  codexyz plugin remove sample@debug\n  codexyz plugin remove sample --marketplace debug"
)]
